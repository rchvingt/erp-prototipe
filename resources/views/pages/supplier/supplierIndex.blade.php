...
@section('content')
    ...
    <script>
        function confirmDelete(id) {
            // Ubah action form delete sesuai dengan id_supplier yang akan dihapus
        ...
        <div class="card">
            <div class="card-datatable table-responsive">
                <div class="table-responsive text-nowrap">
                    <table class="table datatables-supplier border-top">
                        <thead>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                <a class="dropdown-item text-danger"
                                                    onclick="confirmDelete({{ $row->id_supplier }})">
        ...
        $(document).ready(function() {
            $('.datatables-supplier').dataTable({
                ...
                buttons: [{
                    ...
                    text: '<i class="bx bx-plus bx-sm me-sm-2"></i> <span class="d-none d-sm-inline-block">Tambah Supplier Baru</span>',
                    className: "create-new btn btn-primary",
                    action: function(e, dt, button, config) {
                        window.location = '{{ route('ref-supplier.create') }}';
                    }
                }],

            }), $("div.head-label").html('<h5 class="mb-0 card-title">Master Supplier</h5>'), $(
